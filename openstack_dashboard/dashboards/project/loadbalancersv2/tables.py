...
class TerminateLoadBalancer(tables.BatchAction):
    ...
    def action(self, request, obj_id):
        api.lbui.vip_delete(request, obj_id)
...
class EnableLoadBalancer(tables.BatchAction):
    ...
    def action(self, request, obj_id):
        api.lbui.vip_set_status(request, obj_id, True)
...
class DisableLoadBalancer(tables.BatchAction):
    ...
    def action(self, request, obj_id):
        api.lbui.vip_set_status(request, obj_id, False)
...
class UpdateRow(tables.Row):
    ...
    def get_data(self, request, loadbalancer_id):
        loadbalancer = api.lbui.vip_update(request, loadbalancer_id)
        return loadbalancer
...
def get_lb(instance):
    if hasattr(instance, "vip_address"):
        return "%s:%s" % (instance.vip_address, instance.listener['protocol_port'])
